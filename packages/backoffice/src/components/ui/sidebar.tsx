	...
	if (collapsible === "none") {
		return (
			<div
				data-slot="sidebar"
				className={cn(
					"bg-sidebar border-border border-r text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col",
					className,
				)}
				{...props}
			>
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			data-sidebar="header"
			className={cn("flex flex-col gap-2 p-2 border-border border-b h-13", className)}
			{...props}
		/>
	);
}
